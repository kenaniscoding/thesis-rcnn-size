...
bars1 = plt.bar(x - width, abs(df["GT Length"]), width, label="Ground Truth", alpha=0.8)
bars2 = plt.bar(x, abs(df["V2 Length"]), width, label="V2 Code", alpha=0.8)
bars3 = plt.bar(x + width, abs(df["V1 Length"]), width, label="V1 Code", alpha=0.8)
...
plt.figure(figsize=(14, 8))
bars1 = plt.bar(x - width, abs(df["GT Width"]), width, label="Ground Truth", alpha=0.8)
bars2 = plt.bar(x, abs(df["V2 Width"]), width, label="V2 Code", alpha=0.8)
bars3 = plt.bar(x + width, abs(df["V1 Width"]), width, label="V1 Code", alpha=0.8)
...
plt.figure(figsize=(14, 8))
bars1 = plt.bar(x - width/2, abs(df["V2 Length % Diff"]), width, label="V2 Code", alpha=0.8, color='orange')
bars2 = plt.bar(x + width/2, abs(df["V1 Length % Diff"]), width, label="V1 Code", alpha=0.8, color='green')
...
plt.figure(figsize=(14, 8))
bars1 = plt.bar(x - width/2, abs(df["V2 Width % Diff"]), width, label="V2 Code", alpha=0.8, color='orange')
bars2 = plt.bar(x + width/2, abs(df["V1 Width % Diff"]), width, label="V1 Code", alpha=0.8, color='green')
